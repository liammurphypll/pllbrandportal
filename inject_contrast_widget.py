...
def build_widget_block(team_name, team_slug, section_number, logo_variants, bucket_colors, html_dir=None):
  ...
  <div class="content" style="padding-top:0;">
    ...
    (function () {{
      ...
      // Threshold at 0.40 (vs WCAG mathematical breakeven 0.179) so that
      // saturated brand colors — Outlaws orange, Palms pink, vivid reds —
      // are treated as "dark" and get the white 1-color logo, matching how
      // teams actually use the logo. Only truly light/pastel colors (lum > 0.40)
      // get the dark logo.
      ...
      function update() {{
        ...
        // Full-color logos stay fixed regardless of background — picker still controls bg
        el.stage.style.backgroundColor = pickerHex;
        el.hexInput.value = pickerHex.replace('#', '');
        updateSliderPositions();
        el.pickerWrap.classList.remove('disabled');
